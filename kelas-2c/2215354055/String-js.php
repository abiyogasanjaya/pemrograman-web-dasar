...
<body>
    ...
    <script>
        ...
        var kataKelima = kalimat[21] + kalimat[22] + kalimat[24] + kalimat[25];
        ...
        var kataKedua3 = kalimat3.substring(4, 13); // = Tambahkan sendiri di sini!
        ...
        var kataKedua4 = kalimat4.substr(4, 13); // = Tambahkan sendiri di sini!
        var kataKetiga4 = kalimat4.substr(15, 16); // = Tambahkan sendiri di sini!
        var kataKeempat4 = kalimat4.substr(18, 19); // = Tambahkan sendiri di sini!
        var kataKelima4 = kalimat4.substr(21, 25); // = Tambahkan sendiri di sini!

        var panjangKataPertama1 = contohKataPertama4.length; // output nya panjang string "wow" adalah 3
        var panjangKataPertama2 = kataKedua4.length; // Buat variabel baru di sini untuk mendapatkan panjang dari kata selanjutnya : panjangKataKedua4, panjangKataKetiga4, 
        var panjangKataPertama3 = kataKetiga4.length; // panjangKataKeempat4, panjangKataKelima4
        var panjangKataPertama4 = kataKeempat4.length;
        var panjangKataPertama5 = kataKelima4.length;

        document.getElementById("firstWord4").innerHTML = "First Word : " + contohKataPertama4 + ', with length: ' + panjangKataPertama1;
        document.getElementById("secondWord4").innerHTML = "Second Word : " + kataKedua4 + ', with length: ' + panjangKataPertama2; // lengkapi sesuai dengan variabel yang kamu buat
        document.getElementById("thirdWord4").innerHTML = "Third Word : " + kataKetiga4 + ', with length: ' + panjangKataPertama3; // lengkapi sesuai dengan variabel yang kamu buat
        document.getElementById("fourthWord4").innerHTML = "Fourth Word : " + kataKeempat4 + ', with length: ' + panjangKataPertama4; // lengkapi sesuai dengan variabel yang kamu buat
        document.getElementById("fifthWord4").innerHTML = "Fifth Word : " + kataKelima4 + ', with length: ' + panjangKataPertama5; // lengkapi sesuai dengan variabel yang kamu buat
    </script>
</body>
