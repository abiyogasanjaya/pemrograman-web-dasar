...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            var kataKedua = kalimat[8] + kalimat[19] + kalimat[18] + kalimat[15] + kalimat[18];
            var kataKetiga = kalimat[4] + kalimat[5] + kalimat[9] + kalimat[5]; 
            var kataKeempat = kalimat[8] + kalimat[15] + kalimat[12];
            var kataKelima = kalimat[5] +kalimat[18] +kalimat[24]+ kalimat[15];
