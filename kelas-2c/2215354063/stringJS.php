...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            var kataKedua = kalimat[4] + kalimat[5] + kalimat[2] + kalimat[5]; // = Tambahkan sendiri di sini!
            var kataKetiga = kalimat[18] + kalimat[19] + kalimat[12] + kalimat[11]; // = Tambahkan sendiri di sini!
            var kataKeempat = kalimat[4] + kalimat[5] + kalimat[24] + kalimat[5];// = Tambahkan sendiri di sini!
            var kataKelima = kalimat[24] +kalimat[23] +kalimat[12] // = Tambahkan sendiri di sini!
