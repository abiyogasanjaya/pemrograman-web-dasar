...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            var kataKedua = kalimat[4] + kalimat[5] + kalimat[0] + kalimat[5]; // = Tambahkan sendiri di sini!
            var kataKetiga = kalimat[8] + kalimat[1] + kalimat[24] + kalimat[1]; // = Tambahkan sendiri di sini!
            var kataKeempat = kalimat[4] + kalimat[5] + kalimat[8] + kalimat[5]; // = Tambahkan sendiri di sini!
            var kataKelima = kalimat[24] + kalimat[23] + kalimat[23]; // = Tambahkan sendiri di sini!
