...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            var kataKedua = kalimat[4] + kalimat[5] + kalimat[6] + kalimat[7] + kalimat[8] + kalimat[9] + kalimat[10] + kalimat[11] + kalimat[12] + kalimat[13] + kalimat[14];// = Tambahkan sendiri di sini!
            ...
            var kataKetiga4 = kalimat4.substr(15, 3); // = Tambahkan sendiri di sini!
            var kataKeempat4 = kalimat4.substr(18, 3); // = Tambahkan sendiri di sini!
            var kataKelima4 = kalimat4.substr(20, 5); // = Tambahkan sendiri di sini!

            var panjangKataPertama4 = contohKataPertama4.length; // output nya panjang string "wow" adalah 3
            var panjangKataKedua4 = kataKedua4.length;// Buat variabel baru di sini untuk mendapatkan panjang dari kata selanjutnya : panjangKataKedua4, panjangKataKetiga4, 
            var panjangKataKetiga4 = kataKetiga4.length;// panjangKataKeempat4, panjangKataKelima4
