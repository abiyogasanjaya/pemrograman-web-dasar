...
<script>
    ...
    var kataKedua = kalimat[4] + kalimat[5] + kalimat[9] + kalimat[10] + kalimat[18];
    var kataKetiga = kalimat[9] + kalimat[10] + kalimat[11] + kalimat[12];
    var kataKeempat = kalimat[12] + kalimat[19] + kalimat[22];
    var kataKelima = kalimat[4] +kalimat[5] +kalimat[6]+ kalimat[7];
