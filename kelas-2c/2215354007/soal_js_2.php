    ...
    <script>
        ...
        */
        ...
        function buatKalimat(nama, umur, alamat, hobi) {
            ...
            Tampilkan dengan cara document.getElementById("jawaban3").innerHTML = "Nama saya "+nama+", umur saya "+umur+"tahun, alamat saya di "+alamat+", dan saya punya hobby yaitu gaming!"
        }
