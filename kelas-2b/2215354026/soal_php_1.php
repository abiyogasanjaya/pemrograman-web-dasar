...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Kata kedua: " . substr($string2, strpos($string2, ' ') + 1, strpos($string2, ' ', strpos($string2, ' ') + 1) - strpos($string2, ' ') - 1) . "<br>";
        echo "Kata ketiga: " . substr($string2, strrpos($string2, ' ') + 1) . "<br>";
